...
// // Start port listener for local development
...
// Read base URL and automatically strip trailing slashes if present
const rawFastApiUrl = process.env.FASTAPI_URL || 'http://127.0.0.1:8000';
const FASTAPI_URL = rawFastApiUrl.replace(/\/+$/, '');

// Enable explicit CORS for cross-deployment communication
app.use(cors({
    origin: '*',
